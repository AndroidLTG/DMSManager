 ...
 */
public class ListOrderArrayAdapter extends ArrayAdapter<ItemOrder> {
    Activity context = null;
    ArrayList<ItemOrder> myArray = null;
    int layoutId;
     ...
     */
    public ListOrderArrayAdapter(Activity context,
                                 int layoutId,
    ...
    public View getView(int position, View convertView,
        ...
        if (myArray.size() > 0 && position >= 0) {
            ...
            final ItemOrder emp = myArray.get(position);
